...
class TestDBStorage(unittest.TestCase):
    ...
    def test_get(self):
        ...
        new_state.save()
        new_user = User(email="tmmi333@gmail.com", password="1234")
        new_user.save()
        self.assertIs(new_state, models.storage.get("State", new_state.id))
        self.assertIs(None, models.storage.get("State", "asd"))
        self.assertIs(None, models.storage.get("asd", "asd"))
    ...
    def test_count(self):
        ...
        self.assertEqual(models.storage.count("asd"), 0)
        new_state = State(name="California")
        new_state.save()
        new_user = User(email="tmmi333@gmail.com", password="1234")
        new_user.save()
